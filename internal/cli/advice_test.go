...
func TestAdvise(t *testing.T) {
	...
	t.Run("should name the unknown model and point at --list-models", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("should say the local check passed when the server rejects a count", func(t *testing.T) {
		t.Parallel()
