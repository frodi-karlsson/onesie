...
{"type":"user","message":{"content":[{"type":"text","text":"` + "```sh\\nonesie 'from the user'\\n```" + `"}]}}
{"type":"assistant","message":{"content":[{"type":"text","text":"Run onesie 'in prose'.\n` + "```sh\\nonesie 'a'\\n```\\nand\\n```\\nonesie 'b'\\n```" + `"}]}}
{"type":"assistant","message":{"content":[{"type":"tool_use","name":"Bash","input":{"command":"onesie 'c' --print-request"}}]}}
{"type":"assistant","message":{"content":[{"type":"tool_use","name":"Read","input":{"file_path":"x"}}]}}
`,
			want: []string{"onesie 'a'\n", "onesie 'b'\n", "onesie 'c' --print-request"},
		},
		{
