---
description: A onesie step in CI must tell exit 1 apart from exits 2 through 5.
max_turns: 10
allowed_tools: [Read, Glob, Grep, Skill]
---

Add a step to our GitHub Actions workflow that uses the onesie CLI to fail the build when the pull
