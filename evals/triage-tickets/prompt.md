...
the jev CLI to route every ticket to billing, shipping or support, and append each routed ticket
with its team to routed.jsonl. Write the job script. jev is installed and has a key.
